...
const extensionMap: Record<string, { icon: typeof File; color: string }> = {
    ...
    apng: { icon: FileImage, color: 'text-pink-400' },
    ...
    tif: { icon: FileImage, color: 'text-pink-400' },
    tiff: { icon: FileImage, color: 'text-pink-400' },
    ...
    weba: { icon: FileAudio, color: 'text-green-400' },
